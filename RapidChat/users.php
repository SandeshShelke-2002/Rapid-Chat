...
<body>
          ...
          <div class="w3-sidebar w3-bar-block w3-border-right" style="display:none;" id="mySidebar">
            ...
            <a href="myc2.html" class="w3-bar-item w3-button">Contact</a>
            <a href="mya2.html" class="w3-bar-item w3-button">Help</a>
            <a href="feed2.html" class="w3-bar-item w3-button">Report</a> 
