...
session_start();
  ...
  if(isset($_POST['change'])){
      ...
      {
        echo "<script type='text/javascript'>alert('Error! your profile isn't update.'); window.location='adminuserprofile.php'</script>";
      }
       else
       {
        echo "<script type='text/javascript'>alert('Your profile is updated.'); window.location='homea.php'</script>";
       }
  }
